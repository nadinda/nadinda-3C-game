...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Move(Vector2 axisDirection)
    {
        ...
        else if (isPlayerClimbing)
        {
            ...
            Vector3 checkerLeftPosition = transform.position + (transform.up * 1) + (-transform.right * .6f);
        ...
        {
            _rotationDegree.x += _glideRotationSpeed.x * axisDirection.y * Time.deltaTime;
            _rotationDegree.x = Mathf.Clamp(_rotationDegree.x, _minGlideRotationX, _maxGlideRotationX);
            _rotationDegree.z += _glideRotationSpeed.z * axisDirection.x * Time.deltaTime;
            _rotationDegree.y += _glideRotationSpeed.y * axisDirection.x * Time.deltaTime;
    ...
    private void Crouch()
    {
        ...
        bool isHeadBlocked = Physics.Raycast(checkerUpPosition,
            transform.up,
            0.25f,
            _groundLayer);
        ...
        else if (_playerStance == PlayerStance.Crouch && !isHeadBlocked)
        {
